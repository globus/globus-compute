...
class Executor(concurrent.futures.Executor):
    ...
    def register_source_code(
        ...
        **registration_kwargs,
        ...
        :param function_name: The name of the entrypoint function within the source code
        :param registration_kwargs: Additional keyword arguments passed to
            :meth:`Client.register_source_code
            <globus_compute_sdk.Client.register_source_code>`
        :returns: UUID string of the registered function
        """
        if self._stopped:
            raise RuntimeError(f"{self!r} is shutdown; refusing to register function")
