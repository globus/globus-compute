...
class Executor(concurrent.futures.Executor):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param result_serializers: A list of Strategylike objects that will be sent to
            ...
            returning the first successful serialization. If falsy, the endpoint will
            use the default strategies.
    ...
    def result_serializers(self) -> t.Iterable[Strategylike] | None:
        """
        A list of Strategylike objects that will be sent to the endpoint for use in
        serializing task results. The endpoint will attempt to serialize results with
        each strategy in the list until one succeeds, returning the first successful
        serialization. If falsy, the endpoint will use the default strategies.

        Must be valid Strategylike objects. Set by simple assignment::
