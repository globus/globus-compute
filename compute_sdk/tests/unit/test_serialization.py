...
def test_combo_strategies_serialize_fail(
...
def test_combo_strategies_serialize_log_fail(
    strategy_cls: t.Type[ComboSerializationStrategy], data: t.Any, mocker: MockerFixture
):
    strategy = strategy_cls()
...
def test_combo_strategies_deserialize_fail(
    strategy_cls: t.Type[ComboSerializationStrategy], data: t.Any, mocker: MockerFixture
):
    strategy = strategy_cls()
    for s in strategy.strategies:
...
def test_combo_strategies_deserialize_log_fail(
    strategy_cls: t.Type[ComboSerializationStrategy], data: t.Any, mocker: MockerFixture
):
    strategy = strategy_cls()
    sub_strategy_cls = strategy.strategies[
...
def test_combo_strategies_deserialize_invalid_strategy(
    strategy_cls: t.Type[ComboSerializationStrategy], data: t.Any, mocker: MockerFixture
):
    strategy = strategy_cls()
    invalid_id = "BAD\n"
...
def test_combo_strategies_deserialize_malformed_identifier(
    strategy_cls: t.Type[ComboSerializationStrategy], data: t.Any, mocker: MockerFixture
):
    strategy = strategy_cls()
    malformed_id = "MISSING_NEWLINE"
