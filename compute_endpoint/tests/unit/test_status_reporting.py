...
from globus_compute_endpoint.engines import GlobusComputeEngine, ProcessPoolEngine
...
def proc_pool_engine():
    ep_id = uuid.uuid4()
    executor = ProcessPoolEngine(max_workers=2, heartbeat_period_s=HEARTBEAT_PERIOD)
