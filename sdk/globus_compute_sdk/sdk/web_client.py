...
class WebClient(globus_sdk.BaseClient):
    ...
    # config. However, Compute has its own logic for determining the base URL.
    # set `service_name` to allow the check which ensures this is set to pass
    # it does not have any other effects
    service_name: str = "globus_compute"
    # use the Globus SDK error class, not a Compute-specific one
    ...
    # support custom user extensions of the default compute app name
    @property
