...
To execute a function with the ``Executor`` interface, you simply call ``submit``
and pass a reference to the function. Optionally, you may also specify any input
