...
These YAML configurations serve as convenience interfaces to Python configuration
classes used internally by Compute endpoints.  Anything specified in YAML is conveyed
