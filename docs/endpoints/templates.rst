...
files, administrators can create a single :ref:`configuration template <user-config-template-yaml-j2>`
to generate customized configurations based on user-provided variables.
