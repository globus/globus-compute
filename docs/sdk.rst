...
another serializer, use the ``serializer`` member of the :class:`~globus_compute_sdk.Executor`:
...
You can also pass ``serializer`` as an argument to the :class:`~globus_compute_sdk.Executor` constructor.
:doc:`For an up-to-date list of serialization strategies, see here. </reference/serialization_strategies>`
