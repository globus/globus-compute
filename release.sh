...
VERSION="$(grep '^__version__' sdk/globus_compute_sdk/version.py | cut -d '"' -f 2)"
ENDPOINT_VERSION="$(grep '^__version__' endpoint/globus_compute_endpoint/version.py | cut -d '"' -f 2)"
